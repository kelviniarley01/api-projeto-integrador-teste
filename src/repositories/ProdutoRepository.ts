...
export class ProdutoRepository {
    salvar(produto: Produto): Produto {
        const resultado = db
            .prepare('INSERT INTO produtos (nome, descricao,tamanho, id_categoria, preco, descricao, estoque) VALUES (?, ?, ?, ?, ?, ?, ?)')
            .run(produto.nome, produto.descricao, produto.tamanho, produto.id_categoria, produto.preco, produto.descricao, produto.estoque);
